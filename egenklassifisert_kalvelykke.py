# -*- coding: utf-8 -*-
""" Egenklassifisert data maskinlæring
"""
...
# Data prepro
act = pk.import_activity('atferd_kalvelykke\Egenklassifisert_atf_bevegelse.csv')
...
X_train, y_train, X_test, y_test = mlk.create_ser_train_test(acc_act, serials[0], serials[1], att)
...
model_gru.compile(loss='categorical_crossentropy', optimizer=Adam(lr=0.001), metrics=['acc'])
...
model_lstm.add(tf.keras.layers.Dense(units=9, activation='relu'))
